<?php 
	...
	if (isset($_POST['edit']) && $_POST['_action_'] == 'TRUE') {
		...
		$_SESSION['message'] = '<p>Uspješno ste promjenili korisnika!</p>';
	...
	#Edit user profile
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<input type="text" id="fname" name="firstname" value="' . $row['firstname'] . '" placeholder="" required>
			<label for="lname">Prezime *</label>
			<input type="text" id="lname" name="lastname" value="' . $row['lastname'] . '" placeholder="" required>
				
			<label for="email">E-mail *</label>
			<input type="email" id="email" name="email"  value="' . $row['email'] . '" placeholder="" required>
			
			<label for="username">Korisničko ime *<small>(Korisničko ime mora sadržavati najmanje 5, a najviše 10 znakova)</small></label>
			<input type="text" id="username" name="username" value="' . $row['username'] . '" pattern=".{5,10}" placeholder="" required><br>

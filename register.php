<?php 
	...
	if ($_POST['_action_'] == FALSE) {
		...
		<form action="" id="registration_form" name="registration_form" method="POST">
			...
			<input type="text" id="username" name="username" pattern=".{5,10}" placeholder="" required><br>
			
									
			<label for="password">Lozinka:* <small>(Lozinka mora sadržavati najmanje 4 znaka)</small></label>
			<input type="password" id="password" name="password" placeholder="" pattern=".{4,}" required>
